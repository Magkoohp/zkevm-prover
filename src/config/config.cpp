...
void Config::load(json &config)
{
   ...
   // MT associative cache
    ...
    ParseString(config, "recursive1Verifier", "RECURSIVE1_VERIFIER", recursive1Verifier, configPath + "/recursive1/recursive1.dat");
    ...
    ParseString(config, "recursive2Verifier", "RECURSIVE2_VERIFIER", recursive2Verifier, configPath + "/recursive2/recursive2.dat");
    ...
    ParseString(config, "blobInnerRecursive1Verifier", "BLOB_INNER_RECURSIVE1_VERIFIER", blobInnerRecursive1Verifier,configPath + "/blob_inner_recursive1/blob_inner_recursive1.dat");
    ...
    ParseString(config, "blobOuterVerifier", "BLOB_OUTER_VERIFIER", blobOuterVerifier,configPath + "/blob_outer/blob_outer.dat");
    ...
    ParseString(config, "blobOuterRecursive2Verifier", "BLOB_OUTER_RECURSIVE2_VERIFIER", blobOuterRecursive2Verifier,configPath + "/blob_outer_recursive2/blob_outer_recursive2.dat");
    ...
    ParseString(config, "recursivefVerifier", "RECURSIVEF_VERIFIER", recursivefVerifier, configPath + "/recursivef/recursivef.dat");
    ParseString(config, "recursivefVerkey", "RECURSIVEF_VERKEY", recursivefVerkey, configPath + "/recursivef/recursivef.verkey.json");
    ParseString(config, "finalVerifier", "FINAL_VERIFIER", finalVerifier, configPath + "/final/final.dat");
